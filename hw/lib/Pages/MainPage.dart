...
import 'package:hw/Views/ImageLineItem.dart';
import 'package:hw/Views/ImageUploader.dart';
import 'package:hw/Views/UserView.dart';
...
class _MainPageState extends State<MainPage> {
  ...
  void _showImageUploader() async {
    String key = await showDialog(
      context: context,
      //NOTE TODO
      //child: new SimpleDialog(title: Text("Upload Image"), children: [ImageUploader()])
    );
